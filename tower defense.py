...
towers = [Tower(8, 999999, 120, 1250, 60, towersWidth, towersHeight, "seller", 'archer', 325), Tower(0, 200, 120, 1250, 260, towersWidth, towersHeight, "seller", "iceWarrior", 400), Tower(1, 150, 4, 1250, 460, towersWidth, towersHeight ,"seller", "area", 550), Tower(2, 200, 60, 1250, 660, towersWidth, towersHeight ,"seller", "knight", 100)]
    ...
    if health > 0:
        ...
        for tower in towers:
            if tower.type == "seller":
                ...
                elif tower.sellerType == "iceWarrior":
